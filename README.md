...
I'm a student passionate about **Artificial Intelligence, Machine Learning, and building real-world software**. I love turning ideas into working projects — from intelligent desktop assistants to computer vision systems.

- 🔭 Currently building an **ML-Powered Multi-Agent AI Assistant** (Python desktop app with web search, OCR, camera, AI chat & more)
- 🌱 Learning **Python, Machine Learning, Arduino/Embedded Systems**
- ⚡ Interests: AI automation, computer vision, natural language processing
